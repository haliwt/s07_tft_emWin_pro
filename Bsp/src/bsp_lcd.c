...
if (__HAL_DMA_GET_FLAG(DMA1,DMA_FLAG_TE1))
{
   __HAL_DMA_CLEAR_FLAG(DMA1, HAL_DMA_ERROR_TE);
   __HAL_DMA_CLEAR_FLAG(DMA1, DMA_FLAG_TE1);
    __HAL_DMA_CLEAR_FLAG(DMA1, DMA_FLAG_TC1);
	__HAL_DMA_CLEAR_FLAG(DMA1, DMA_FLAG_GI1 );
	__HAL_DMA_CLEAR_FLAG(DMA1, DMA_FLAG_HT1);
