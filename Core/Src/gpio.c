...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC,TFT_DCX_Pin|VOICE_SOUND_Pin, GPIO_PIN_RESET);
  
   HAL_GPIO_WritePin(GPIOB, TFT_BACKLIGHT_Pin,GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_PTC_Pin|LED_RAT_Pin|LED_WIFI_Pin|LED_KILL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PCPin PCPin */
  GPIO_InitStruct.Pin = TFT_BACKLIGHT_Pin|TFT_DCX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin */
  GPIO_InitStruct.Pin = RELAY_CTL_Pin|LED_PTC_Pin|LED_RAT_Pin|LED_WIFI_Pin
                          |LED_KILL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
